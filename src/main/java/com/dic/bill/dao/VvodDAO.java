...
public interface VvodDAO extends JpaRepository<Vvod, Integer> {
	 ...
	 */
	@Query(value = "select distinct d.id from TEST201903.C_VVOD d " +
			"join TEST201903.KART k on d.HOUSE_ID=k.HOUSE_ID " +
			"join TEST201903.USL u on d.usl=u.usl and u.fk_calc_tp is not null " +
